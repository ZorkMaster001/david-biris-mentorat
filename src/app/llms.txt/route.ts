...
export function GET(): Response {
  const body = [
    ...
    "",
    `Antrenor personal în ${CITY} și online. Mentorat 1-la-1 pentru slăbit, forță și`,
    "obiceiuri care rămân: sală, nutriție, antrenament, motivație și disciplină.",
    "",
    "Nu predă box, înot sau cățărat — le practică el însuși. Ce face pentru client e",
    "să așeze sala și mâncarea în jurul sportului și al hobby-urilor pe care le are deja,",
    "ca omul să nu fie nevoit să renunțe la ele ca să arate bine.",
    "",
    "Mentoratul se desfășoară față în față în Târgu Mureș sau online, în română și engleză.",
    "",
